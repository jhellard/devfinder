const Header = () => {
  ...
  return (
    <header className="pt-8 sm:pt-0 pb-9 px-6 bg-transparent flex items-center max-w-[621px] md:max-w-[778px] mx-auto">
      ...
      <div
        className="flex items-center dark:hidden cursor-pointer group"
        onClick={handleThemeSwitch}
      >
        <span className="text-[13px] text-lightBlue mr-4 font-bold group-hover:text-blackHover tracking-[2.5px]">
          DARK
        </span>
        <svg
          className="text-lightBlue group-hover:text-blackHover"
          width="20"
          height="20"
      ...
      <div
        className="hidden dark:flex items-center cursor-pointer group"
        onClick={handleThemeSwitch}
      >
        <span className="text-[13px] text-white mr-4 font-bold group-hover:text-lightHover tracking-[2.5px]">
          LIGHT
        </span>
        <svg
          className="text-white group-hover:text-lightHover"
          width="20"
          height="20"
          xmlns="http://www.w3.org/2000/svg"
        >
