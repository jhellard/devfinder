      ...
      <main className="max-w-[621px] md:max-w-[778px] mx-auto">
        ...
        <section className="mx-6 bg-veryLightWhite rounded-2xl pt-8 mb-8 sm:mb-0 px-6 sm:px-10 md:px-12 shadow-lg dark:bg-darkModeBlue md:flex gap-[37px]">
          ...
          <div>
            <div className="flex gap-5 sm:gap-10 mb-8 sm:items-center sm:mb-6 md:items-start">
              ...
              <div className="md:grid grid-cols-2 grow">
                ...
                <h2 className="text-[13px] text-grayishBlue dark:text-white sm:text-[15px] md:col-start-2 md:row-start-1 justify-self-end self-center">
                  Joined {moment(data.created_at).format("D MMM YYYY")}
                </h2>
              </div>
            </div>
            ...
            <ul className="px-4 sm:px-8 bg-lightBg dark:bg-darkBg min-h-[85px] mb-6 sm:mb-[30px] md:mb-[37px] flex items-center rounded-[10px] justify-between sm:justify-start text-darkBg dark:text-white">
